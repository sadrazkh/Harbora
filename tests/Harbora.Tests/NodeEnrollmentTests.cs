...
// Disambiguates the control plane's own node summary from the one a v1 node reports in its hello
// frame. These tests are about the second. See the same alias in NodeEnrollmentService.
