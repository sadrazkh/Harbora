...
public enum ConfigOverrideValueKind
{
    ...
    /// config-delivery plan) — resolved at deploy time through
    /// <c>Harbora.Application.Abstractions.IAttachedServiceConnectionStringResolver</c>, never stored
    /// here itself. This is what lets an operator point <c>ConnectionStrings:Default</c> at an
    /// attached database and never see its password.
    /// </summary>
