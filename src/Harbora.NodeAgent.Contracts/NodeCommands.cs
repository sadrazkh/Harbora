...
public static class NodeCommands
{
    ...
    public const string GetWorkloadStats = "GetWorkloadStats";
...
public static class NodeCommandCatalog
{
    private static readonly Dictionary<string, NodeCommandDescriptor> Map =
        new(StringComparer.Ordinal)
        {
            ...
            // Read-only and not idempotent-tracked: every call is a fresh sample, and replaying
            // one would hand back a reading from a minute ago as though it were now.
            [NodeCommands.GetWorkloadStats] = new(NodeCommands.GetWorkloadStats, NodeScopes.WorkloadsRead, 60, false),
